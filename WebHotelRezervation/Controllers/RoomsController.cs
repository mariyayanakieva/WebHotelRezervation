...
namespace WebHotelRezervation.Controllers
{
    public class RoomsController : Controller
    {
        ...
        {
            var hotelDbContext = _context.Rooms.Include(r => r.RoomType);
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Beds,RoomTypeId,Price")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Beds,RoomTypeId,Price")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
